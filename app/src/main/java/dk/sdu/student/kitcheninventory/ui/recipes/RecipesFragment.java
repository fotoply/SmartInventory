...
import dk.sdu.student.kitcheninventory.data.recipe.RecipeAllRecipesData;
...
public class RecipesFragment extends Fragment
{
                             ...
                             ViewGroup container, Bundle savedInstanceState)
    {
        ...
        recyclerView.setAdapter(new RecipesRecyclerViewAdapter(root.getContext(), RecipeAllRecipesData.GetData()));
