...
public class InventoryRecyclerViewAdapterBeverages extends RecyclerView.Adapter<InventoryRecyclerViewAdapterBeverages.RecyclerViewHolder>
{
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        {
            super(itemView);
            name = itemView.findViewById(R.id.beveragesProductNameTextView);
            icon = itemView.findViewById(R.id.beveragesProductIconImageView);
            amount = itemView.findViewById(R.id.beveragesAmountTextView);
